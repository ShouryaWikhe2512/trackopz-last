...
export default function HomePage(): React.ReactElement {
  ...
  const username = null; // or provide a string if available
  ...
  const handleUpdateDetails = (): void => {
    ...
    console.log('Dispatch Menu clicked');
  };
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <header className="bg-white shadow-sm px-4 py-4 flex items-center justify-between sticky top-0 z-20">
        ...
        <h1 className="text-lg md:text-xl font-semibold text-blue-700 text-center flex-grow">Operator Panel</h1>
        ...
        <div className="w-full max-w-md mx-auto space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            >
              ...
              <span className="text-gray-700 font-medium text-xs md:text-sm text-center">Add Job</span>
            </button>
              ...
              <div className="w-10 h-10 md:w-12 md:h-12 bg-blue-50 rounded-full flex items-center justify-center relative">
                ...
                {isAuthenticated && alertCount > 0 && (
                  <div className="absolute -top-1 -right-1 w-4 h-4 md:w-5 md:h-5 bg-red-500 rounded-full flex items-center justify-center">
                    <span className="text-white text-[10px] md:text-xs font-medium">{alertCount}</span>
                  </div>
                )}
              </div>
              <span className="text-gray-700 font-medium text-xs md:text-sm text-center">See Alerts!</span>
            </button>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            >
              ...
              <span className="text-gray-700 font-medium text-xs md:text-sm text-center">Recently Added Products</span>
            </button>
            ...
            >
              ...
              <span className="text-gray-700 font-medium text-xs md:text-sm text-center">Product Count</span>
            </button>
          </div>
          ...
          <div className="flex justify-center">
            ...
            >
              ...
              <span className="text-gray-700 font-medium text-xs md:text-sm text-center">Dispatched Menu</span>
            </button>
          </div>
        </div>
      </main>
